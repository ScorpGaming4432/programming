...
Well, my journey will probs be random codes in random languages (for now, mainly Rust and C) but if i'll care enough i'll update the codes with some description or whatever
## Why even do this?
